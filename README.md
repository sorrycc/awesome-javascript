...
- [Next.js](https://nextjs.org) - A React-based framework for building production application. With zero configuration it provides features like server-side rendering, file-system routing, optimized code-spliting and bundling, route pre-fetching amongst others.
