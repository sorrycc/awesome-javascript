...
* [Validare](https://github.com/validarejs/validare) - Plugin-based form validation library with 51 built-in validators, zero dependencies, and TypeScript support
