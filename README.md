...
* [Zeal](https://zealdocs.org/) - Regurarly updated Offline Documentation browser. It can be used for JavaScript libraries & frameworks, including other programming languages.
