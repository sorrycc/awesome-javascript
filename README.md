...
* [Prettier](https://github.com/prettier/prettier) - A code formatter that removes all original styling and ensures that all outputted code conforms to a consistent style.
