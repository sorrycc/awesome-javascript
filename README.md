...
* [FilePond](https://github.com/pqina/filepond) - A dependency free Drag n' Drop file upload library, optimizes images for faster uploads, and offers an accessible and animated user interface.
