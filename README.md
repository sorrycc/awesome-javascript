...
* [Sigment](https://github.com/sigmentjs/basic-sigment-typescript-vite) - A fine-grained reactive framework for building lightning-fast apps — no virtual DOM, no JSX, no transpilation.
