...
* [fdatepicker](https://github.com/liedekef/fdatepicker) - Vanilla JS datetime picker with keyboard navigation and using PHP date-syntax for datetime formatting.
